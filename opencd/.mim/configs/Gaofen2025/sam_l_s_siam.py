_base_ = [
    '../_base_/models/siam_upernet_sam_l_s_multimodals.py', '../_base_/datasets/Gaofen2025.py',
...
default_hooks = dict(checkpoint=dict(type='CheckpointHook', interval=1000,save_best='mIoU',max_keep_ckpts=4),
