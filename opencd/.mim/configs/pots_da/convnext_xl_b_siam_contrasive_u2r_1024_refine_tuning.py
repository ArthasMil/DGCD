_base_ = [
    '../_base_/models/siam_upernet_convnext_xl_b_multimodals_contrasive_with_refine.py', '../_base_/datasets/loveda_u2r_1024.py',
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        type='AdamW', lr=0.1e-6, betas=(0.9, 0.999), weight_decay=0.05),
    paramwise_cfg={
        'decay_rate': 0.9,
