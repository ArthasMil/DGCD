...
class SiamEncoderDecoderTwoBack(BaseSegmentor):
    ...
    def __init__(self,
        ...
        backbone2 = {'type': 'mmpretrain.ConvNeXt', 'arch': 'small', 'out_indices': [0, 1, 2, 3], 'drop_path_rate': 0.4, 'layer_scale_init_value': 1.0, 'gap_before_final_norm': False, 'init_cfg': {'type': 'Pretrained', 'checkpoint': 'https://download.openmmlab.com/mmclassification/v0/convnext/downstream/convnext-small_3rdparty_32xb128-noema_in1k_20220301-303e75e3.pth', 'prefix': 'backbone.'}}
